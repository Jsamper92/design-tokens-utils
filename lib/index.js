...
const designSystemsUtils = (args) => {
    try {
        const { theme, path, tokens, disableIconFont, disableIconSprites, disableIconsFigma } = config(args);
        ...
        if (existData) {
            ...
            if (theme) {
                data = data[theme] || {};
                createTokens(data, path, theme, disableIconFont, disableIconSprites, disableIconsFigma);
            } else {
                ...
                if (isThemeTokensStudio) {
                    ...
                    createTokens(dataTokensStudio, path, themesTokensStudio, disableIconFont, disableIconSprites, disableIconsFigma);
                }
            }
        } else {
